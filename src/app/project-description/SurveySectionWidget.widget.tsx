...
import SurveyQuestionWidget from "./SurveyQuestionWidget.widget";
import { SurveySection, SURVEY_SECTION_META } from "./table";

export type Data = SurveySection;

export const Fields = {
    name: TextWidget,
    questions: ListWidget(SurveyQuestionWidget),
};

function Component(props: Props) {
    return (
        <>
            <widgets.questions addButtonText="Add Question" />
        </>
    );
}
    ...
    component: React.memo((props: Props) => {
        return (
            <ReactContext.Provider value={props}>
                <RecordContext meta={SURVEY_SECTION_META} value={props.data}>
                    {Component(props)}
                </RecordContext>

...
import { ThirdPartySpecifier, THIRD_PARTY_SPECIFIER_META } from "./table";

export type Data = ThirdPartySpecifier;
...
const Widget: RecordWidget<State, Data, Context, Action, ExtraProps> = {
    ...
    dataMeta: THIRD_PARTY_SPECIFIER_META,
    initialize(
        data: Data,
        context: Context,
        parameters?: string[]
    ...
    component: React.memo((props: Props) => {
        return (
            <ReactContext.Provider value={props}>
                <RecordContext
                    meta={THIRD_PARTY_SPECIFIER_META}
                    value={props.data}
                >
                    {Component(props)}
                </RecordContext>

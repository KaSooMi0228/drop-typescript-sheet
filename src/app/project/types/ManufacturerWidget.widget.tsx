...
import { Manufacturer, MANUFACTURER_META } from "./table";

export type Data = Manufacturer;
    ...
    component: React.memo((props: Props) => {
        return (
            <ReactContext.Provider value={props}>
                <RecordContext meta={MANUFACTURER_META} value={props.data}>
                    {Component(props)}
                </RecordContext>

...
import DetailSheetOptionFinishScheduleWidget from "./DetailSheetOptionFinishScheduleWidget.widget";
import { DetailSheet, DETAIL_SHEET_META } from "./table";

export type Data = DetailSheet;

const Fields = {
    options: TabsWidget(DetailSheetOptionFinishScheduleWidget, {
        emptyOk: true,
    }),
};

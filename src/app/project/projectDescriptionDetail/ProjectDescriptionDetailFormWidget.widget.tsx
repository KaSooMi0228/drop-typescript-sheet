...
function Component(props: Props) {
    ...
    return (
        <FieldRow>
            <widgets.category wrapperStyle={{ maxWidth: "20em" }} />
            <widgets.description
                include={includeDescription}
                wrapperStyle={{ maxWidth: "20em" }}
            />
            {projectDescription?.requireDetail && (
                <widgets.custom wrapperStyle={{ marginRight: "14.5em" }} />
            )}
        </FieldRow>
    );
}

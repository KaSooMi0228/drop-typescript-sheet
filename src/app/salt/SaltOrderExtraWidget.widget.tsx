...
import { SaltOrderExtra, SALT_ORDER_EXTRA_META } from "./table";

export type Data = SaltOrderExtra;
...
const Widget: RecordWidget<State, Data, Context, Action, ExtraProps> = {
    ...
    dataMeta: SALT_ORDER_EXTRA_META,
    initialize(
        data: Data,
        context: Context,
        parameters?: string[]
    ...
    component: React.memo((props: Props) => {
        return (
            <ReactContext.Provider value={props}>
                <RecordContext meta={SALT_ORDER_EXTRA_META} value={props.data}>
                    {Component(props)}
                </RecordContext>

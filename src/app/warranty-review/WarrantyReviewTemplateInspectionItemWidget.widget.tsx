...
import {
    ...
    WARRANTY_REVIEW_TEMPLATE_INSPECTION_ITEM_META,
} from "./table";

export type Data = WarrantyReviewTemplateInspectionItem;
...
const Widget: RecordWidget<State, Data, Context, Action, ExtraProps> = {
    ...
    dataMeta: WARRANTY_REVIEW_TEMPLATE_INSPECTION_ITEM_META,
    initialize(
        data: Data,
        context: Context,
        parameters?: string[]
    ...
    component: React.memo((props: Props) => {
        return (
            <ReactContext.Provider value={props}>
                <RecordContext
                    meta={WARRANTY_REVIEW_TEMPLATE_INSPECTION_ITEM_META}
                    value={props.data}
                >
                    {Component(props)}
                </RecordContext>

...
import { ContractNote, CONTRACT_NOTE_META } from "./table";

export type Data = ContractNote;
    ...
    component: React.memo((props: Props) => {
        return (
            <ReactContext.Provider value={props}>
                <RecordContext meta={CONTRACT_NOTE_META} value={props.data}>
                    {Component(props)}
                </RecordContext>

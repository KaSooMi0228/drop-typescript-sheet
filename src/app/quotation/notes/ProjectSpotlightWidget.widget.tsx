...
import { ProjectSpotlight, PROJECT_SPOTLIGHT_META } from "./table";

export type Data = ProjectSpotlight;
...
const Widget: RecordWidget<State, Data, Context, Action, ExtraProps> = {
    ...
    dataMeta: PROJECT_SPOTLIGHT_META,
    initialize(
        data: Data,
        context: Context,
        parameters?: string[]
    ...
    component: React.memo((props: Props) => {
        return (
            <ReactContext.Provider value={props}>
                <RecordContext meta={PROJECT_SPOTLIGHT_META} value={props.data}>
                    {Component(props)}
                </RecordContext>
